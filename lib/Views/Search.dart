        ...
        child: Container(
          child: Column(
            children: [
              ...
              Expanded(
                child: mainProvider.searchList.length == 0
                    ? Center(
                      ...
                      onTap: () {
                        ...
                        Navigator.push(
                            ...
                            GlobalFunction.route(OfferDetails(
                              offerModel: mainProvider.searchList[index],
                            )));
                      },
                      child: Material(
                        child: Column(
                          children: [
                                          ...
                                          children: [
                                            ClipRRect(
                                              ...
                                              BorderRadius.circular(
                                                  10),
                                              child: LoadImage(
                                                image: mainProvider.searchList[index]
                                                    .photo[0],
                                                height:
                                  ...
                                  Positioned(
                                      ...
                                      child: Container(
                                          ...
                                          child: Column(
                                            ...
                                            children: [
                                              Text(
                                                mainProvider.searchList[index].price,
                                                style: TextStyle(
                                                    height: 1.0,
                                                    fontWeight:
                                                    FontWeight.bold,
                            ...
                            SizedBox(
                              ...
                              child: Text(
                                mainProvider.searchList[index].name,
